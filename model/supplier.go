...
type CreateSupplierReq struct {
	...
	ContactEmail    string `json:"contact_email" binding:"omitempty,max=100,email"`
...
type UpdateSupplierReq struct {
	SupplierCode    string `json:"supplier_code,omitempty" binding:"max=50"`
	SupplierName    string `json:"supplier_name,omitempty" binding:"max=200"`
	ContactPerson   string `json:"contact_person,omitempty" binding:"max=100"`
	...
	SupplierAddress string `json:"supplier_address,omitempty" binding:"max=500"`
