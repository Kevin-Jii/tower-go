...
func InitMenuSeeds(db *gorm.DB) error {
	...
	menus := []model.Menu{
		...
		{ID: 6, ParentID: 1, Name: "role", Title: "角色管理", Icon: "team", Path: "/system/role", Component: "system/role/index", Type: 2, Sort: 2, Permission: "system:role:list", Visible: 1, Status: 1},
		...
		{ID: 11, ParentID: 1, Name: "menu", Title: "菜单管理", Icon: "menu", Path: "/system/menu", Component: "system/menu/index", Type: 2, Sort: 3, Permission: "system:menu:list", Visible: 1, Status: 1},
		...
		{ID: 21, ParentID: 20, Name: "store-list", Title: "门店列表", Icon: "unordered-list", Path: "/store/list", Component: "store/list/index", Type: 2, Sort: 1, Permission: "store:list", Visible: 1, Status: 1},
		...
		// 菜品管理（目录）
		{ID: 30, ParentID: 0, Name: "dish", Title: "菜品管理", Icon: "coffee", Type: 1, Sort: 3, Visible: 1, Status: 1},
		{ID: 31, ParentID: 30, Name: "dish-list", Title: "菜品列表", Icon: "unordered-list", Path: "/dish/list", Component: "dish/list/index", Type: 2, Sort: 1, Permission: "dish:list", Visible: 1, Status: 1},
		...
		// 报菜管理（目录）
		{ID: 40, ParentID: 0, Name: "report", Title: "报菜管理", Icon: "file-text", Type: 1, Sort: 4, Visible: 1, Status: 1},
		{ID: 41, ParentID: 40, Name: "report-list", Title: "报菜记录", Icon: "unordered-list", Path: "/report/list", Component: "report/list/index", Type: 2, Sort: 1, Permission: "report:list", Visible: 1, Status: 1},
		...
		{ID: 45, ParentID: 40, Name: "report-stats", Title: "数据统计", Icon: "bar-chart", Path: "/report/statistics", Component: "report/statistics/index", Type: 2, Sort: 2, Permission: "report:statistics", Visible: 1, Status: 1},
	}
