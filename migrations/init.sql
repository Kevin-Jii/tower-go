...
CREATE TABLE IF NOT EXISTS `store_accounts` (
  ...
  `gift_wine_product_id` BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '赠酒商品ID',
  `gift_wine_product_name` VARCHAR(200) NOT NULL DEFAULT '' COMMENT '赠酒商品名称',
  `gift_wine_unit` VARCHAR(50) NOT NULL DEFAULT '' COMMENT '赠酒规格/单位',
  `gift_wine_quantity` DECIMAL(10,2) NOT NULL DEFAULT 0 COMMENT '赠酒数量',
  ...
  KEY `idx_store_accounts_gift_wine_product_id` (`gift_wine_product_id`),
...
CREATE TABLE IF NOT EXISTS pre_orders (
  ...
  store_id BIGINT UNSIGNED NOT NULL COMMENT '门店ID',
  customer_id BIGINT UNSIGNED NOT NULL COMMENT '会员ID',
  customer_name VARCHAR(100) NOT NULL COMMENT '会员名称快照',
