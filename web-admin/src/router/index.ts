...
export function resetDynamicRoutes(router: Router): void {
  ...
  if (router.hasRoute(NOT_FOUND_CATCH_ALL))
    router.removeRoute(NOT_FOUND_CATCH_ALL);
}
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import("@/views/system/third-party-account/routes.vue"),
        meta: { title: "物流路线图" },
      },
      {
        ...
        component: () =>
          import("@/views/system/third-party-account/route-import.vue"),
        meta: { title: "导入第三方订单" },
      },
      {
        ...
        component: () =>
          import("@/views/system/third-party-account/route-history.vue"),
        meta: { title: "历史物流单" },
      },
    ],
  },
